...
# The first step is to set up virtual machines due to limited individual computational power.  
...
# The key for VM’s connection didn’t work due to permission restrictions. The chmod 600 command used for file permission.
...
flexbar -h # open flexbar help to test the flexbar installation

# Installing cutadapt  if you are not working on Ubuntu
conda install -c bioconda cutadapt
cutadapt -h # open cutadapt help to test the cutadapt installation
...
picard -h # open picard help to test the picard installation

# Installing Bamtools
conda install -c bioconda bamtools
bamtools -h # open bamtools help to test the bamtools installation
